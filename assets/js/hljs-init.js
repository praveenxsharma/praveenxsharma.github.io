// hljs-init.js — Highlight.js + tab bar + copy button + line numbers
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('pre').forEach(function (pre) {
    ...
    // Tab bar (language label) — skip if data-filename is set
